...
datasink = glueContext.write_dynamic_frame.from_options(frame = relationalized1, connection_type = "s3", connection_options = {"path": "s3://ifi-cloudtrails/parquet"}, format = "parquet", transformation_ctx = "datasink4")
job.commit()
